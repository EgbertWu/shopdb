...
from web.controllers.role.Role import route_role
from web.controllers.access.Access import route_access
...
app.register_blueprint( route_role, url_prefix = '/role')
app.register_blueprint( route_access, url_prefix = '/access')